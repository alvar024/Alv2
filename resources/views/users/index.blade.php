    ...
    <div class="col-lg-12">
        <div class="card card-stats shadow mb-4">
            <div class="card-header pb-0">
                <span class='h5'>@lang('Users Management')</span>
                <div class="float-end">
                    <a class="btn bg-gradient-success btn-sm" href="{{ route('users.create') }}"> @lang('Create New User') </a>
                </div>
                    ...
                    <table class="table align-items-center mb-0">
                     ...
                     @foreach ($data as $key => $user)
                      <tr>
                        ...
                        <td>
                           <a class="btn bg-gradient-warning btn-sm" data-toggle="tooltip" data-original-title="@lang('Edit user')" href="{{ url('users/create?id='.$user->id) }}">@lang('Ver y Editar')</a>
